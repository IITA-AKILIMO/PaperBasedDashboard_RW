...
## the LGAMaps function produces a pdf file with three maps and csn files and it sabes both in the directory as set before running the function
##############################################################################################################
...
setwd("D:/ACAI_Wrapper/cloud_compute/FR/NG/BenueCrossRiver_Acre")

for(m in month.name){
  LGAMaps(plantMonth=m,  cities = c("Makurdi"), lgaGroups = "Benue",
          LGApoints = Benue, stateLabel = Benue_label, textangle=0, unit="acre", couple = "One")
}

for(m in month.name){
  LGAMaps(plantMonth=m,  cities = c("Calabar"), lgaGroups = "Cross River",
          LGApoints = CrossRiver, stateLabel = CrossRiver_label, textangle=0, unit="acre", couple = "Two")
}

setwd("D:/ACAI_Wrapper/cloud_compute/FR/NG/BenueCrossRiver")
for(m in month.name){
  LGAMaps(plantMonth=m,  cities = c("Calabar", "Makurdi"), lgaGroups = "Benue_Cross River",
          LGApoints = Benue_CR, stateLabel = Benue_CRlabel, textangle=0, unit="ha", couple = "One")
}


setwd("D:/ACAI_Wrapper/cloud_compute/FR/NG/Delta")
for(m in month.name){
  LGAMaps(plantMonth=m,  cities = c("Asaba"), lgaGroups = "Delta",
          LGApoints = Delta, stateLabel = Deltalabel, textangle=0, unit="ha", couple = "One")
}

setwd("D:/ACAI_Wrapper/cloud_compute/FR/NG/Delta_Acre")
for(m in month.name){
  LGAMaps(plantMonth=m,  cities = c("Asaba"), lgaGroups = "Delta",
          LGApoints = Delta, stateLabel = Deltalabel, textangle=0, unit="acre", couple = "One")
}

setwd("D:/ACAI_Wrapper/cloud_compute/FR/NG/Edo")
for(m in month.name){
  LGAMaps(plantMonth=m,  cities = c("Benin City"), lgaGroups = "Edo",
          LGApoints = Edo, stateLabel = Edolabel, textangle=0, unit="ha", couple = "One")
}

setwd("D:/ACAI_Wrapper/cloud_compute/FR/NG/Edo_Acre")
for(m in month.name){
  LGAMaps(plantMonth=m,  cities = c("Benin City"), lgaGroups = "Edo",
          LGApoints = Edo, stateLabel = Edolabel, textangle=0, unit="acre", couple = "One")
}

setwd("D:/ACAI_Wrapper/cloud_compute/FR/NG/Imo")
for(m in month.name){
  LGAMaps(plantMonth=m,  cities = c("Owerri"), lgaGroups = "Imo",
          LGApoints = Imo, stateLabel = Imolabel, textangle=0, unit="ha", couple = "One")
}

setwd("D:/ACAI_Wrapper/cloud_compute/FR/NG/Imo_Acre")
for(m in month.name){
  LGAMaps(plantMonth=m,  cities = c("Owerri"), lgaGroups = "Imo",
...
setwd("D:/ACAI_Wrapper/cloud_compute/FR/NG/AkwaIbom_Acre")
for(m in month.name){
  LGAMaps(plantMonth=m,  cities = c("Uyo"), lgaGroups = "Akwa Ibom",
          LGApoints = Akwa_Ibom, stateLabel = Akwa_Ibomlabel, textangle=0, unit="acre", couple = "One")
}

setwd("D:/ACAI_Wrapper/cloud_compute/FR/NG/Ekiti")
for(m in month.name){
...
setwd("D:/ACAI_Wrapper/cloud_compute/FR/NG/Ekiti_Acre")
for(m in month.name){
  LGAMaps(plantMonth=m,  cities = c("Ado Ekiti"), lgaGroups = "Ekiti",
...
setwd("D:/ACAI_Wrapper/cloud_compute/FR/NG/Anambra_Acre")
for(m in month.name){
  LGAMaps(plantMonth=m,  cities = c("Awka"), lgaGroups = "Anambra",
...
setwd("D:/ACAI_Wrapper/cloud_compute/FR/NG/Ebonyi_Acre")
for(m in month.name){
  LGAMaps(plantMonth=m,  cities = c("Ebonyi"), lgaGroups = "Ebonyi",
...
setwd("D:/ACAI_Wrapper/cloud_compute/FR/NG/Taraba")
for(m in month.name){
...
setwd("D:/ACAI_Wrapper/cloud_compute/FR/NG/Oyo_Acre")
for(m in month.name){
...
setwd("D:/ACAI_Wrapper/cloud_compute/FR/NG/Oyo")
for(m in month.name){
  LGAMaps(plantMonth=m,  cities = "Oyo", lgaGroups = "Oyo", LGApoints = Oyo, 
...
tablepdf <- function(unit, fname, state){
  setwd(paste("D:/ACAI_Wrapper/cloud_compute/FR/NG/", fname, sep=""))
...
tablepdf(unit="acre", fname="BenueCrossRiver_Acre", state="Benue")
...
##############################################################################################################
ds <- FR_TZ_FCY2_plm ## ds will be defined based on the current yield. e.g. if user idicate that thier current yield is yield level 2 ds  = FR_NG_FCY2_plm
...
setwd("D:/ACAI_Wrapper/cloud_compute/FR/TZ/Mtwara_Lindi_Acre") ## maps and table for the selected using will be stored in the defined director for every region
for(m in month.name){
...
setwd("D:/ACAI_Wrapper/cloud_compute/FR/TZ/Mtwara_Lindi")
for(m in month.name){
...
setwd("D:/ACAI_Wrapper/cloud_compute/FR/TZ/Pwani_Tanga_Acre")
for(m in month.name){
...
setwd("D:/ACAI_Wrapper/cloud_compute/FR/TZ/Pwani_Tanga")
for(m in month.name){
...
setwd("D:/ACAI_Wrapper/cloud_compute/FR/TZ/Mwanza_Shinyanga_Acre")
for(m in month.name){
...
setwd("D:/ACAI_Wrapper/cloud_compute/FR/TZ/Mwanza_Shinyanga")
for(m in month.name){
...
setwd("D:/ACAI_Wrapper/cloud_compute/FR/TZ/Mara_Simiyu_Acre")
for(m in month.name){
...
setwd("D:/ACAI_Wrapper/cloud_compute/FR/TZ/Mara_Simiyu")
for(m in month.name){
  LGAMaps_TZ(plantMonth=m,  cities = Maracity, lgaGroups = "Mara_Simiyu",
             LGApoints = Mara, stateLabel = Maralabel, textangle=0, unit="ha", couple = "Two")
}

setwd("D:/ACAI_Wrapper/cloud_compute/FR/TZ/Kagera_Geita_Kigoma_Acre")
for(m in month.name){
...
setwd("D:/ACAI_Wrapper/cloud_compute/FR/TZ/Kagera_Geita_Kigoma")
for(m in month.name){
...
setwd("D:/ACAI_Wrapper/cloud_compute/FR/TZ/Zanzibar_Acre")
for(m in month.name){
...
setwd("D:/ACAI_Wrapper/cloud_compute/FR/TZ/Zanzibar")
for(m in month.name){
  LGAMaps_TZ(plantMonth=m,  cities = Zanzibarcity, lgaGroups = c("Zanzibar South and Central", "Zanzibar West", "Zanzibar North"),
...
tablepdf_TZ <- function(unit, fname, REGION){
  setwd(paste("D:/ACAI_Wrapper/cloud_compute/FR/TZ/", fname, sep=""))
  listcsv <- list.files(getwd(), "csv")
  library(gtable)
  for(files in c(listcsv, listcsv[1])){
    plantMonth <-  strsplit(files, '_')[[1]][1]
